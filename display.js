  ...
  fetch(`https://medicalproject1010.herokuapp.com/conditions?searchKey=${meal}`)
    ...
    .then(condition => {
      ...
      var cols = `
                    ...
                    <div align=center>
                    <img src="${conditions.diseaseImage[0]}" alt="" />
                    </div>
                    ...
                    <div align=center>
                    <img src="${conditions.diseaseImage[1]}" class="img-fluid h-50 w-25" alt="" />
                    </div>
                    ...
                    <p>${conditions.causes}</p>
                    <div align=center>
                    <img src="${conditions.diseaseImage[2]}" class="img-fluid h-50 w-25" alt="" />
                    </div>
              `;
